...
import static com.gt.demo.natives.renders.NativeDemoRender.printImgUrl;
...
import com.gt.demo.databinding.DemoNativeFeedAdItemBinding;
...
public class NativeDemoFeedRender {
    ...
    public View renderAdView(NativeAdData adData, NativeAdEventListener nativeAdEventListener) {
        ...
        if (adData.getAdInteractiveType() == NativeAdInteractiveType.NATIVE_DOWNLOAD && adData.getAdAppInfo() != null) {
            ...
            adData.bindViewForInteraction(binding.getRoot(), clickableViews, creativeViewList, null, binding.privacyContainer, nativeAdEventListener);

        } else {
            binding.privacyContainer.setVisibility(View.GONE);
            adData.bindViewForInteraction(binding.getRoot(), clickableViews, creativeViewList, null, null,nativeAdEventListener);
        }
